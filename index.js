...
const ThingsToDo = () => {
    return (
        <main
            className="page things-to-do"
            data-attribute-page="things-to-do"
        >
            <div className="page-header">
                <header>
                    <h1>Things to Do</h1>
                ...
                <article>
                    <div className="content-block">
                        ...
                        <div className="icon-label">
                            <i className="fas fa-exclamation-triangle" />
                            <span className="icon-text small">
                                Advanced trails available requiring
                    ...
                    <div className="content-block">
                        ...
                        <p>
                            Slather on some sunblock and swim, paddle or
                            kayak on Alice Lake. Bring food and snacks!
                        </p>
                    ...
                    <div className="content-block">
                        ...
                        <p>
                            Walking on tree canopies for sightseeing or
                            beginner to advanced ziplining for touring,
                    ...
                    <div className="content-block">
                        ...
                        <p>
                            Whale watching, rock climbing, waterfalls,
                            hikes, mountain-biking, white-water rafting,
                            rope courses, canyoneering, kite-boarding and
                            windsurfing.
                        </p>
                    </div>
                </article>
